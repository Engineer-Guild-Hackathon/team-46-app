...
describe('BookPage', () => {
  ...
  it('shows word-level tooltip with translation or fallback', async () => {
    ...
    const firstWord = container.querySelector('.sentenceInline span.word') as HTMLElement | null
    if (firstWord) {
      ...
      const tooltip = firstWord.querySelector('.word-tooltip') as HTMLElement | null
