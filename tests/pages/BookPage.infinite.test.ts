...
describe('BookPage infinite scroll', () => {
  ...
  it('calls API only once when user scrolls twice within cooldown', async () => {
    ...
    Object.defineProperty(reader, 'scrollHeight', { value: 2000, configurable: true })
    ...
    Object.defineProperty(reader, 'scrollTop', { value: 1500, configurable: true })
    ...
    Object.defineProperty(reader, 'scrollTop', { value: 1600, configurable: true })
    await fireEvent.scroll(reader)
