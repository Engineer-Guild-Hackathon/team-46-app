...
export const LOG_ENDPOINTS = {
  openJapanese:
    "https://us-central1-flexread-egh.cloudfunctions.net/log/openJapanese",
  difficultBtn:
    "https://us-central1-flexread-egh.cloudfunctions.net/difficultBtn",
} as const;
...
export async function logOpenJapanese(
  params: OpenJapaneseLogParams,
): Promise<LogResult> {
...
export async function logDifficultBtn(
  params: DifficultBtnLogParams,
): Promise<LogResult> {
